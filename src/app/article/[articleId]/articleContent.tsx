...
import { Book } from "@/app/_icons/book";
import { BackArrow } from "@/app/_icons/backArrow";
  ...
  return (
    <div className="-mt-5 flex flex-col gap-6">
      <button
        ...
        onClick={handlePushToQuizGenerator}
      >
        <BackArrow />
      </button>
      <div className="w-[38.0444vw] h-[459px] rounded-lg border border-[#E4E4E7] bg-white p-7 flex flex-col justify-between">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            className="w-[108px] h-10 rounded-md bg-[#18181B] text-white font-medium cursor-pointer hover:bg-[#3b3b3b] duration-200"
